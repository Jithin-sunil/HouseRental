...
$sel = "SELECT * FROM tbl_owner WHERE owner_id = '" . $ownerId . "'";
$res = $Con->query($sel);
$row = $res->fetch_assoc();
?>
...
<head>
    ...
    <title>Chat with <?php echo $row["owner_name"] ?></title>
...
<body>
    ...
    <div class="profile-modal" id="profile">
        <div class="profile-content">
            ...
            <img src="../Assets/Files/Owner/<?php echo $row["owner_photo"] ?>" alt="Profile">
        </div>
    </div>
    <div class="chat-container">
        <div class="chat-header">
            <img src="../Assets/Files/Owner/<?php echo $row["owner_photo"] ?>" alt="Profile" onclick="openProfile()">
            <div class="user-info">
                <h3><?php echo $row["owner_name"] ?></h3>
                <input type="hidden" id="recipientId" value="<?php echo $ownerId ?>">
            </div>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            formData.append("ownerId", recipientId);
        ...
        function clearChat() {
            ...
            $.ajax({
                url: `../Assets/AjaxPages/UAjaxChat.php?action=clear&ownerId=${recipientId}`,
                success: () => {
                    alert("Chat cleared");
                    loadMessages();
                },
        ...
        function loadMessages() {
            ...
            $.ajax({
                url: `../Assets/AjaxPages/AjaxChatLoad.php?ownerId=${recipientId}`,
                success: (data) => {
