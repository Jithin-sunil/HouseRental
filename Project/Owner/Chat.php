...
$sel = "SELECT * FROM tbl_user WHERE user_id = '" . $_GET["userId"] . "'";
$res = $Con->query($sel);
$row = $res->fetch_assoc();
?>
...
<head>
    ...
    <title>Chat with <?php echo $row["user_name"] ?></title>
    ...
    <style>
        ...
        .chat-container {
            ...
            height: 90vh;
            position: relative; /* FIX: This makes the container a positioning context */
        }
...
<body>
    ...
    <div class="profile-modal" id="profile">
        <div class="profile-content">
            ...
            <img src="../Assets/Files/User/<?php echo $row["user_photo"] ?>" alt="Profile">
        </div>
    </div>
    <div class="chat-container">
        <div class="chat-header">
            <img src="../Assets/Files/User/<?php echo $row["user_photo"] ?>" alt="Profile" onclick="openProfile()">
            <div class="user-info">
                <h3><?php echo $row["user_name"] ?></h3>
                <input type="hidden" id="recipientId" value="<?php echo $_GET["userId"] ?>">
            </div>
    ...
    <script>
        ...
        function sendMessage() {
            ...
            $.ajax({
                url: "../Assets/AjaxPages/OAjaxChat.php",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        function deleteMessage(chatId) {
            if (confirm("Are you sure you want to delete this message?")) {
                $.ajax({
                    url: `../Assets/AjaxPages/OAjaxChat.php?action=delete&chat_id=${chatId}`,
        ...
        function clearChat() {
            ...
            if (confirm("Are you sure you want to clear all messages?")) {
                ...
                $.ajax({
                    url: `../Assets/AjaxPages/OAjaxChat.php?action=clear&userId=${recipientId}`,
                    success: () => {
                        alert("Chat cleared");
                        loadMessages();
                    },
        ...
        function loadMessages() {
            ...
            $.ajax({
                url: `../Assets/AjaxPages/AjaxChatLoadO.php?userId=${recipientId}`,
                success: (data) => {
